...
function renderNewLesson(topic,note,index,title,units){
 ...
 root.innerHTML=`<div class="pdf-action-bar" aria-label="PDF actions"><button class="pill small" type="button" onclick="window.PX_PRINT_UNIT?PX_PRINT_UNIT():window.print()">🖨️ Print</button><button class="pill small" type="button" onclick="window.PX_PRINT_UNIT?PX_PRINT_UNIT():window.print()">📄 Save PDF</button></div><div class="notebook"><div class="print-brand"><img src="assets/princexmahto-logo.svg" alt="PrinceXmahto"><span>PrinceXmahto Study · Semester I</span></div><div class="notebook-inner">
